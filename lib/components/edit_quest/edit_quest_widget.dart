...
import 'edit_quest_model.dart';
export 'edit_quest_model.dart';

class EditQuestWidget extends StatefulWidget {
  const EditQuestWidget({
    super.key,
  ...
  @override
  State<EditQuestWidget> createState() => _EditQuestWidgetState();
}

class _EditQuestWidgetState extends State<EditQuestWidget>
    with TickerProviderStateMixin {
  late EditQuestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditQuestModel());

    _model.titleTextController ??=
        TextEditingController(text: widget.quest?.title);
    ...
    _model.xpTextController ??=
        TextEditingController(text: widget.quest?.xpReward.toString());
    _model.xpFocusNode ??= FocusNode();

    _model.categoryTextController ??=
        TextEditingController(text: widget.quest?.category);
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<QuestsRow>>(
      future: QuestsTable().queryRows(
        queryFn: (q) => q.eqOrNull('id', widget.questId),
      ),
                                ...
                                children: [
                                  ...
                                  FlutterFlowDropDown<String>(
                                    controller: _model.difficultyValueController ??=
                                        FormFieldController<String>(widget.quest?.difficulty),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Switch(
                                    value: _model.isActiveValue ??= widget.quest?.isActive ?? true,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Retired quests are hidden from students',
                                          style: FlutterFlowTheme.of(context).bodySmall.override(
                                                fontFamily: 'Feather',
                                                color: const Color(0xFF9CA3AF),
                                                fontSize: 11.0,
                                  ...
                                  Switch(
                                    value: _model.isRetiredValue ??= widget.quest?.isRetired ?? false,
                                    onChanged: (newValue) async {
                                      safeSetState(() => _model.isRetiredValue = newValue);
                                    },
                                    activeColor: const Color(0xFFFF5963),
                                    activeTrackColor: const Color(0x4DFF5963),
                                    inactiveTrackColor: const Color(0xFFE5E7EB),
                                    inactiveThumbColor: Colors.white,
                                  ),
                                ],
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      final DateTime? picked = await showDatePicker(
                                        context: context,
                                        initialDate: _model.expirationDate ?? DateTime.now().add(const Duration(days: 7)),
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            _model.expirationDate != null
                                                ...
                                                : (widget.quest?.expirationDate != null
                                                    ? dateTimeFormat('MMMMdd, yyyy', widget.quest!.expirationDate!)
                                                    : 'No expiration date'),
                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                  font: GoogleFonts.plusJakartaSans(
                                                    fontWeight: FontWeight.w500,
                                                  ...
                                                  color: (_model.expirationDate != null || widget.quest?.expirationDate != null)
                                          ...
                                          if (_model.expirationDate != null || widget.quest?.expirationDate != null)
                                            const Spacer(),
                                          if (_model.expirationDate != null || widget.quest?.expirationDate != null)
                                            InkWell(
                                              onTap: () {
                                                setState(() {
                                                  _model.expirationDate = DateTime(1900);
                                                });
                                              },
                                              child: const Icon(
                                                Icons.close,
                                ...
                                onPressed: () async {
                                  ...
                                  if (confirmDialogResponse) {
                                    await QuestsTable().delete(
                                      matchingRows: (rows) => rows.eq('id', widget.questId!),
                                    );
                                    ...
                                    onPressed: () async {
                                      ...
                                      await QuestsTable().update(
                                        data: {
                                          ...
                                          'is_retired': _model.isRetiredValue ?? false,
                                          'expiration_date': (_model.expirationDate != null && _model.expirationDate!.year > 1900)
                                              ? _model.expirationDate!.toIso8601String()
                                              : null,
                                        },
                                        matchingRows: (rows) => rows.eq('id', widget.questId!),
                                      );
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: const Text(
                                              'Quest has been updated successfully.',
                                              style: TextStyle(
                                                fontSize: 14.0,
                                                color: Color(0xFF6B7280),
                                              ),
