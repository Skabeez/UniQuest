...
class AddMissionWidget extends StatefulWidget {
  const AddMissionWidget({super.key});
...
class _AddMissionWidgetState extends State<AddMissionWidget>
  ...
  void initState() {
    ...
    _model.targetValueTextController ??= TextEditingController();
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await MissionsTable().insert({
                                ...
                                'description': _model.notesTextController.text,
                                'reward_points':
                                    int.tryParse(_model.xpTextController.text),
                                'trigger': _model.triggerValue,
                                'target_value': int.tryParse(
                                    _model.targetValueTextController.text),
                              });
                              await showDialog(
                                context: context,
