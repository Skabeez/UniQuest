...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CustomizeProfileWidget.routeName,
          path: CustomizeProfileWidget.routePath,
          builder: (context, params) => const CustomizeProfileWidget(),
        ),
        FFRoute(
          name: OnboardingWidget.routeName,
          path: OnboardingWidget.routePath,
          builder: (context, params) => OnboardingWidget(
            uploadedImageUrl: params.getParam(
              'uploadedImageUrl',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : TodoListWidget(
                  tasksrow: params.getParam<TasksRow>(
                    'tasksrow',
        ...
        FFRoute(
          name: ActiveMissionsWidget.routeName,
          path: ActiveMissionsWidget.routePath,
          builder: (context, params) => const ActiveMissionsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: OnboardingContainerWidget.routeName,
          path: OnboardingContainerWidget.routePath,
          builder: (context, params) => const OnboardingContainerWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const WelcomeviewWidget(),
        ),
        FFRoute(
          name: TodoListCopyWidget.routeName,
          path: TodoListCopyWidget.routePath,
          builder: (context, params) => TodoListCopyWidget(
        ...
        FFRoute(
          name: TsaCreationPageWidget.routeName,
          path: TsaCreationPageWidget.routePath,
          builder: (context, params) => const TsaCreationPageWidget(),
        ),
        FFRoute(
          name: ArchiveTasksWidget.routeName,
          path: ArchiveTasksWidget.routePath,
          builder: (context, params) => ArchiveTasksWidget(
        ...
        FFRoute(
          name: NotifWidget.routeName,
          path: NotifWidget.routePath,
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'notif') : const NotifWidget(),
        ),
        FFRoute(
          name: CosmeticsListWidget.routeName,
          path: CosmeticsListWidget.routePath,
          builder: (context, params) => const CosmeticsListWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const LoginRedirectWidget(),
        ),
        FFRoute(
